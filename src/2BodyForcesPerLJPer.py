...
# in this case we use a perdioc Leonar-Jones potential plus a a
# fourier periodic one
...
from data_gen_1d import genDataLJ_FPer
...
assert potentialType == "Periodic_LJ"
...
if not path.exists(dataFile):
  ...
  pointsArray, \
  potentialArray, \
  forcesArray  = genDataLJ_FPer(Ncells, Np, mu, Nsamples, minDelta, Lcell)
...
pointsTest, \
potentialTest, \
forcesTest  = genDataLJ_FPer(Ncells, Np, mu, 1000, minDelta, Lcell)
